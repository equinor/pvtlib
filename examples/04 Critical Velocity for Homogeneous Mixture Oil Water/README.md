...
```bash
python critical_velocity_for_homogeneous_mixture_oil_water.py
```
...
- Critical velocity for horizontal pipe configuration (m/s)
- Critical velocity for vertical pipe configuration (m/s)
